...
(function initSpecsTable() {
  var table = document.getElementById('elite-specs-table');
  if (!table) return;
...
(function initComparativaHighlight() {
  ...
  /* El modelo activo de esta página es "elite" */
  var activeCols = table.querySelectorAll('[data-model="elite"], .comparativa-col--active');
